...
function App() {
  ...
  return (
    <div className="container min-h-screen bg-gray-100 dark:bg-gray-700">
      <h1 className="text-gray-900 dark:text-white text-4xl text-center py-5">
        PlayAct 🎶
      </h1>
      <div className="flex flex-col mx-auto w-1/2 shadow hover:shadow-xl transition duration-300 lg:rounded-b-xl">
        ...
        <div className="bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-white lg:rounded-b-xl py-4 px-1 sm:px-3 lg:px-1 xl:px-3 flex justify-evenly items-center">
          ...
          <div className="inline-block relative w-16 mx-auto">
            <select
              defaultValue="1.0"
              onChange={handleRate}
              className="block appearance-none w-full text-sm font-medium text-gray-900 dark:text-white bg-white dark:bg-gray-900 border-2 border-gray-900 dark:border-gray-100 hover:border-lime-400 focus:border-lime-400 pl-2 py-1 rounded shadow leading-tight focus:outline-none focus:shadow-outline transition duration-300"
            >
